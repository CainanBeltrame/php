                        ...
                        <div id = "conteudo" class = "col-md-6 col-md-offset-2">
                            <form enctype="multipart/form-data" role="form" data-toggle="validator" action="BLL/EditarManga.php" method="POST" class="form-horizontal">
                                ...
                                <div class = "form-group">
                                    ...
                                    <div class = "col-sm-10">
                                        <input type="number" class = "form-control" step=0.01 min = 0 name = "pManga" placeholder = "14.50" value = "<?PHP ECHO $row['Preco'];?>" required>
                                    </div>
                                </div>
                                <div class = "form-group">
                                    <label for="qtdManga" class = "col-sm-2 control-label">Quantidade</label>
                                    <div class = "col-sm-10">
                                        <input type="number"  min = 0 class = "form-control" name = "qManga" placeholder = "5" value = "<?PHP ECHO $row['Quantidade'];?>"required/>
                                    </div>
                                </div>
                                <div class = "col-sm-10">
                            ...
                            <div id = "conteudo" class = "col-md-6 col-md-offset-2">
                                <form class="form-horizontal" method = "post" action="BLL/DeleteManga.php">
                                    ...
                                    <div class = "form-group">
                                        <label for="preco" class = "col-sm-2 control-label">Preço R$</label>
                                        <div class = "col-sm-10">
                                            <input type="number" class = "form-control" step=0.01 min = 0 name = "precoManga" placeholder = "14.50" disabled value = "<?PHP ECHO $row['Preco'];?>">
                                        </div>
                                    </div>
                                    <div class = "form-group">
                                        <label for="qtdManga" class = "col-sm-2 control-label">Quantidade</label>
                                        <div class = "col-sm-10">
                                            <input type="number" class = "form-control" min = 0 name = "qtdManga" placeholder = "5" disabled value = "<?PHP ECHO $row['Quantidade'];?>"/>
                                        </div>
                                    </div>
                                    <div class = "col-sm-10">
                                        <input type="button" class = "btn btn-primary" value = "CANCELAR" onclick = "history.back()">
